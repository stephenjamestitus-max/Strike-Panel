...
function blogPost(day, d) {
  const inner = `
    ...
    <div class="blog-card">
      ...
      <div class="blog-url">↗ ${d.url || 'strikepane.uk/blog'}</div>
    </div>
    ${DIVIDER}
    ${bottomRow()}`;
...
function pricePost(day, d) {
  ...
  const inner = `
    ...
    <div class="price-cta">
      <div class="price-cta-demo">Demo → strikepane.uk/demo</div>
...
const POSTS = [
  ...
  { day: 10, fn: featurePost, data: {
    ...
    cta: '→ Free demo: strikepane.uk/demo',
  }},
  ...
  { day: 30, fn: featurePost, data: {
    ...
    cta: '→ Try free: strikepane.uk/demo',
