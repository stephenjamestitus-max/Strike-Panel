...
const entryPoint = path.join(root, 'remotion', 'trailer-movie-root.jsx');
const outputFile = path.join(root, 'marketing', 'trailer-movie.mp4');
...
async function render() {
  ...
  const composition = await selectComposition({ serveUrl, id: 'TrailerMovie', inputProps: {} });
  ...
  console.log(`\n\n✅  Saved → marketing/trailer-movie.mp4`);
}
