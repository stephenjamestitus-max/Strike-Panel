const items = ['MORNING BRIEF','FIGHT CAMP','ATHLETE CHECK-IN LINKS','AI SESSIONS','PROGRESS TRACKING','WEIGHT CUT TOOLS','FIGHT COUNTDOWN','READINESS SCORES','CLOUD SYNC','NO ATHLETE APP NEEDED']
